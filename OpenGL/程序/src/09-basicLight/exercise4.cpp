...
int main()
{
    ...
    // 创建着色器程序
    Shader objectShader("./src/09-basicLight/shader/exercise4Vs.glsl", "./src/09-basicLight/shader/exercise4Fs.glsl");
    Shader lightShader("./src/09-basicLight/shader/lightVs.glsl", "./src/09-basicLight/shader/lightFs.glsl");
