...
int main()
{
    ...
    // 创建着色器程序
    opengl::Shader shader("./src/21-cubemaps/shader/vs.glsl", "./src/21-cubemaps/shader/fs.glsl");
    opengl::Shader skyboxShader("./src/21-cubemaps/shader/cbuemapVs.glsl", "./src/21-cubemaps/shader/cubemapFs.glsl");
    ...
    unsigned int floorTexture = opengl::loadTextureFromFile(std::string("./resources/minecreaft/block/birch_planks.png"));
