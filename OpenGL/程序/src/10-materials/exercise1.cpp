...
int main()
{
    ...
    // 创建着色器程序
    Shader objectShader("./src/10-materials/shader/objectVs.glsl", "./src/10-materials/shader/objectFs.glsl");
    Shader lightShader("./src/10-materials/shader/exercise1LightVs.glsl", "./src/10-materials/shader/exercise1LightFs.glsl");
