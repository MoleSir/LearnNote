...
int main()
{
    ...
    // 创建着色器程序
    Shader objectShader("./src/12-lightCasters/shader/objectAttenuationVs.glsl", "./src/12-lightCasters/shader/objectAttenuationFs.glsl");
    Shader lightShader("./src/12-lightCasters/shader/lightVs.glsl", "./src/12-lightCasters/shader/lightFs.glsl");
