...
int main()
{
    ...
    // 创建着色器程序
    Shader objectShader("./src/11-lightingMaps/shader/exercise4objectVs.glsl", "./src/11-lightingMaps/shader/exercise4objectFs.glsl");
    ...
    objectShader.setInt("latterTexture", 2);
