...
int main()
{
    ...
    // 创建着色器程序
    opengl::Shader shader("./src/23-geometryShader/shader/explodeVs.glsl", "./src/23-geometryShader/shader/explodeFs.glsl", "./src/23-geometryShader/shader/explodeGs.glsl");
