...
int main()
{
    ...
    // -------------------------
    opengl::Shader shader("./src/25-advancedLighting/shader/vs.glsl", "./src/25-advancedLighting/shader/fs.glsl");
    ...
    // load textures
    // -------------
    unsigned int floorTexture = opengl::loadTextureFromFile("resources/textures/wood.png");
