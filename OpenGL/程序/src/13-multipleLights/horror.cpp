...
int main()
{
    ...
    Shader lightShader("./src/13-multipleLights/shader/lightHorrorVs.glsl", "./src/13-multipleLights/shader/lightHorrorFs.glsl");
    ...
    // 设置点光
    objectShader.setVec3("pointLights[0].ambient",  0.08f, 0.08f, 0.08f);
    objectShader.setVec3("pointLights[0].diffuse", 0.08f, 0.08f, 0.08f); 
    objectShader.setVec3("pointLights[0].specular", 0.08f, 0.08f, 0.08f);
    objectShader.setVec3("pointLights[0].position", pointLightPositions[0]);
    objectShader.setFloat("pointLights[0].constant",  1.0f);
    objectShader.setFloat("pointLights[0].linear",    0.09f);
    objectShader.setFloat("pointLights[0].quadratic", 0.032f);

    objectShader.setVec3("pointLights[1].ambient",  0.08f, 0.08f, 0.08f);
    objectShader.setVec3("pointLights[1].diffuse", 0.08f, 0.08f, 0.08f); 
    objectShader.setVec3("pointLights[1].specular", 0.08f, 0.08f, 0.08f);
    objectShader.setVec3("pointLights[1].position", pointLightPositions[1]);
    objectShader.setFloat("pointLights[1].constant",  1.0f);
    objectShader.setFloat("pointLights[1].linear",    0.09f);
    objectShader.setFloat("pointLights[1].quadratic", 0.032f);

    objectShader.setVec3("pointLights[2].ambient",  0.08f, 0.08f, 0.08f);
    objectShader.setVec3("pointLights[2].diffuse", 0.08f, 0.08f, 0.08f); 
    objectShader.setVec3("pointLights[2].specular", 0.08f, 0.08f, 0.08f);
    ...
    // 平行光
    objectShader.setVec3("lineLight.ambient",  0.08f, 0.08f, 0.08f);
    objectShader.setVec3("lineLight.diffuse", 0.08f, 0.08f, 0.08f); 
    objectShader.setVec3("lineLight.specular", 0.08f, 0.08f, 0.08f);
