...
int main()
{
    ...
    Shader lightShader("./src/13-multipleLights/shader/lightDesertVs.glsl", "./src/13-multipleLights/shader/lightDesertFs.glsl");
    ...
    // 设置点光
    objectShader.setVec3("pointLights[0].ambient",  0.2f * lightColors[0]);
    objectShader.setVec3("pointLights[0].diffuse", 0.8f * lightColors[0]); 
    ...
    objectShader.setVec3("pointLights[1].ambient",  0.2f * lightColors[1]);
    objectShader.setVec3("pointLights[1].diffuse", 0.8f * lightColors[1]); 
    ...
    objectShader.setVec3("pointLights[2].ambient",  0.2f * lightColors[2]);
    objectShader.setVec3("pointLights[2].diffuse", 0.8f * lightColors[2]); 
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        glClearColor(0.63f, 0.32f, 0.17f, 1.0f);
