...
int main()
{
    ...
    // 创建着色器程序
    Shader objectShader("./src/13-multipleLights/shader/objectAttenuationVs.glsl", "./src/13-multipleLights/shader/objectAttenuationFs.glsl");
    Shader lightShader("./src/13-multipleLights/shader/lightVs.glsl", "./src/13-multipleLights/shader/lightFs.glsl");
