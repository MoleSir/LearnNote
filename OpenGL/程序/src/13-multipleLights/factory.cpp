...
glm::vec3 lightColor(0.118, 0.565, 1.0);
...
int main()
{
    ...
    Shader lightShader("./src/13-multipleLights/shader/lightFactoryVs.glsl", "./src/13-multipleLights/shader/lightFactoryFs.glsl");
