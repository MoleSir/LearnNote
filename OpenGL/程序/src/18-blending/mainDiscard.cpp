...
std::vector<glm::vec3> vegetations 
{
    ...
    glm::vec3( 2.0f, 0.5f, 2.7f),
    glm::vec3( 2.3f, 0.5f, 0.3f),
    glm::vec3( 2.5f, 0.5f, 2.6f)
};
...
int main()
{
    ...
    // 创建着色器程序
    opengl::Shader shader("./src/18-blending/shader/vs.glsl", "./src/18-blending/shader/discardFs.glsl");
    ...
    unsigned int vegetationTexture = opengl::loadTextureFromFile(std::string("./resources/textures/grass.png"), false);
